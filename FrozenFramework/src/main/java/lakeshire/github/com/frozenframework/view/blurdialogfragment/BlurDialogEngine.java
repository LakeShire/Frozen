package lakeshire.github.com.frozenframework.view.blurdialogfragment;
...
//            } else
        ...
        int topOffset = actionBarHeight + statusBarHeight;
        int bottomOffset = getNavigationBarOffset();

        Log.d("liuhan", "top: " + topOffset + ", bottom: " + bottomOffset);
//        bottomOffset = -48;
