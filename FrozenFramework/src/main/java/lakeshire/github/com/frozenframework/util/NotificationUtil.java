...
public class NotificationUtil {
    ...
    public static void notification(Context context, PendingIntent pendingIntent, int id,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            try {
                Method m = clazz.getDeclaredMethod("setLatestEventInfo", Context.class, CharSequence.class, CharSequence.class, PendingIntent.class);
                m.invoke(notification, context, title, msg, pendingIntent);
            } catch (Exception e) {
                e.printStackTrace();
            }
